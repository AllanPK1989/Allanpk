...
echo.
echo   table files (expect 17) : !TMDL!
echo   report pages (expect 10): !PAGES!
echo   visuals (expect 107)    : !VIS!
echo   CSV files (expect 16)   : !CSV!

if !TMDL! LSS 17 set BAD=1
if !PAGES! LSS 10 set BAD=1
if !VIS! LSS 107 set BAD=1
if !CSV! LSS 16 set BAD=1
